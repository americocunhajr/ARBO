...
ydot(1) = - bH*y(1).*y(7);                             % rate of susceptible humans (number of ppl/days)
                                                                       
ydot(2) = bH*y(1).*y(7) - aH*y(2);                     % rate of incubating humans (number of ppl/days)
                                                                        
ydot(3) = aH*y(2) - yH*y(3);                           % rate of infectious humans (number of ppl/days)
                                                                        

ydot(4) = yH*y(3);                                     % rate of recovered humans (number of ppl/days)
                                                                        
ydot(5) = dV - bV.*y(5).*(y(3)/N) - dV*y(5);           % rate of the proportion of susceptible vectors (proportion of vectors/days)
                                                                        

ydot(6) = bV*y(5).*(y(3)/N) - aV*y(6) - dV*y(6);       % rate of the proportion of incubating vectors (proportion of vectors/days)
                                                                        

ydot(7) = aV*y(6) - dV*y(7);                           % rate of the proportion of infectious vectors (proportion of vectors/days)
                                                                        

ydot(8) = aH*y(2);                                     % rate of the number of cumulative infectious humans (number of ppl/days)
