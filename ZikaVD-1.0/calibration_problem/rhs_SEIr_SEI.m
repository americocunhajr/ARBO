...
% -----------------------------------------------------------------
% Calibration problem: rhs_SEIr_SEI.m
%
...
% Inputs:
%   t: time                    - double
%   y: state vector            - double array (7x1)
%   param: parameters vector   - double array (7x1)
%
% Output:
%   dydt: state rate of change - double array (7x1)
% -----------------------------------------------------------------
...
%
%      y = [SH EH IH SV EV IV C]                            is the state vector
%   dydt = [dSHdt dEHdt dIHdt dSVdt dEVdt dIVdt dCdt]       is the evolution law
%     Obs: RH is ommited for better performance 
%
...
[SH EH IH SV EV IV C] = deal(y(1),y(2),y(3),y(4),y(5),y(6),y(7));
...
dCdt  = alphaH*EH;
dydt = [dSHdt; dEHdt; dIHdt; dSVdt; dEVdt; dIVdt; dCdt];
